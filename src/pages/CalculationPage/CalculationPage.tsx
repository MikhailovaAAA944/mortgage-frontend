...
const CalculationPage = () => {
    ...
    const {calculation, fromAirport, toAirport, debt, setToAirport, setFromAirport, setDebt, fetchCalculation, saveCalculation, sendCalculation, deleteCalculation, setCalculation, setCalculationId} = useCalculation()
    ...
    return (
        <div className="calculation-page-wrapper">
            ...
            <div className="calculation-units-wrapper">
                <div className="top">
                    <h3>{is_draft ? "Новый платёж" :  "Авиарейс №" + calculation.id}</h3>
                </div>
                ...
                <div className="inputs-container">
                    ...
                    <CustomInput placeholder="Сумма долга по ипотеке" value={debt} setValue={setDebt} disabled={!is_draft} />
